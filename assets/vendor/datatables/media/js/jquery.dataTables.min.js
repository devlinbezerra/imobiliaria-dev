 ...
 * Documentation for $('.selector').dataTable(): http://legacy.datatables.net/api (returns jQuery Object)
 * Documentation for $('.selector').DataTable(): https://datatables.net/reference/api/ (returns API) 
 */
(function(Ea, P, k) {
	var O = function(h) {
		function V(a) {
		...
		function J(a, b, c, e) {
			var d = a.aoData.length,
				f = h.extend(!0, {}, o.models.oRow, { src: c ? 'dom' : 'data' });
			f._aData = b;
			a.aoData.push(f);
						...
						(g = m[j]),
							...
							g && g._bAttrSrc
								? (Q(g.mData._)(e, i),
								  ...
								  p(g.mData.filter, a))
								: l
								? (g._setter || (g._setter = Q(g.mData)), g._setter(e, i))
								: (e[j] = i);
					j++;
				};
			if (f)
		...
		function Ja(a, b, c, e) {
			...
			if (null === d.nTr) {
				...
				for (p = a.aoColumns.length; l < p; l++) {
					...
					h.fnCreatedCell &&
						h.fnCreatedCell.call(a.oInstance, i, y(a, b, l), f, b, l);
				}
		...
		function mb(a) {
			...
			for (
				var f = a.sDom.split(''), g, j, i, m, l, p, n = 0;
				n < f.length;
				n++
			) {
				g = null;
		...
		function ra(a, b, c) {
			...
			i = {
				...
				error: function(b, c) {
					var f = a.oApi._fnLog;
					'parsererror' == c
						? f(a, 0, 'Invalid JSON response', 1)
						: 4 === b.readyState && f(a, 0, 'Ajax error', 7);
					C(a, !1);
				}
			};
			a.oAjaxData = b;
			...
			for (g = 0; g < c; g++)
				(m = b[g]),
					...
					e.bFilter &&
						...
						n('bSearchable_' + g, m.bSearchable)),
		...
		function xb(a) {
			for (
				var b = o.ext.search, c = a.aiDisplay, e, d, f = 0, g = b.length;
				f < g;
				f++
			) {
		...
		function Y(a) {
			...
			K &&
				((L = K.clone().prependTo(r)), (v = K.find('tr')), (L = L.find('tr')));
			...
			b.bCollapse &&
				'' !== d &&
				(n.height = p[0].offsetHeight + o[0].offsetHeight + 'px');
			g = r.outerWidth();
			if ('' === c) {
				if (
					((u.width = '100%'),
				...
				'' !== e
					? (u.width = s(e))
					: g == p.width() && p.height() < r.height()
					? ((u.width = s(g - f)), r.outerWidth() > g - f && (u.width = s(g)))
					: (u.width = s(g));
			g = r.outerWidth();
			G(E, y);
			G(function(a) {
			...
			if (r.outerWidth() < g) {
				v =
					i.scrollHeight > i.offsetHeight || 'scroll' == p.css('overflow-y')
						? g + f
						: g;
				if (
					w &&
		...
		function Ga(a) {
			...
			if (!p && !f && !d && j == aa(a) && j == i.length)
				...
				for (n = 0; n < e.length; n++)
					(k = c[e[n]]),
						(i[n].style.width =
							null !== k.sWidthOrig && '' !== k.sWidthOrig
								? s(k.sWidthOrig)
								: '');
				if (a.aoData.length)
					for (n = 0; n < e.length; n++)
					...
					for (n = g = 0; n < e.length; n++)
						(k = c[e[n]]),
							...
							(g +=
								null === k.sWidthOrig
									? d
									: parseInt(k.sWidth, 10) + d - h(i[n]).width());
					j.width(s(g));
					b.style.width = s(g);
				}
				for (n = 0; n < e.length; n++)
					if (((k = c[e[n]]), (d = h(i[n]).width()))) k.sWidth = s(d);
		...
		function lb(a) {
			...
			for (c = m.length; b < c; b++)
				(j = m[b]), j.formatter && g++, Ib(a, j.col);
					...
					: h.sort(function(a, b) {
							...
							for (h = 0; h < i; h++)
								if (
									...
									(c = k[j.col]),
									(g = o[j.col]),
									(j = d[j.type + '-' + j.dir] || d['string-' + j.dir]),
									(c = j(c, g)),
									0 !== c)
								)
									return c;
		...
		function Ib(a, b) {
			...
			for (
				var f,
					g = o.ext.type.order[c.sType + '-pre'],
					h = 0,
					i = a.aoData.length;
				h < i;
				h++
		...
		function Wa(a, b) {
			...
			b <= c
				...
				: (a >= b - 1 - e
						? (c = U(b - (c - 2), b))
						: ((c = U(a - 1, a + 2)), c.push('ellipsis'), c.push(b - 1)),
		...
		function Nb(a) {
			return function() {
				var b = [za(this[o.ext.iApiIndex])].concat(
		...
		o = function(a) {
			...
			this.each(function() {
				...
				if ('table' != this.nodeName.toLowerCase())
					...
					if (null === i || '' === i)
						this.id = i = 'DataTables_Table_' + o.ext._unique++;
					...
					i = q.oClasses;
					d.bJQueryUI
						? (h.extend(i, o.ext.oJUIClasses, d.oClasses),
						  d.sDom === l.sDom &&
								'lfrtip' === l.sDom &&
								(q.sDom = '<"H"lfr>t<"F"ip>'),
						  q.renderer)
							? h.isPlainObject(q.renderer) &&
							  !q.renderer.header &&
							  (q.renderer.header = 'jqueryui')
							: (q.renderer = 'jqueryui')
						: h.extend(i, o.ext.classes, d.oClasses);
					p.addClass(i.sTable);
					if ('' !== q.oScroll.sX || '' !== q.oScroll.sY)
						q.oScroll.iBarWidth = Hb();
					!0 === q.oScroll.sX && (q.oScroll.sX = '100%');
					q.iInitDisplayStart === k &&
						((q.iInitDisplayStart = d.iDisplayStart),
						(q._iDisplayStart = d.iDisplayStart));
					null !== d.iDeferLoading &&
						((q.bDeferLoading = !0),
						(g = h.isArray(d.iDeferLoading)),
						(q._iRecordsDisplay = g ? d.iDeferLoading[0] : d.iDeferLoading),
						(q._iRecordsTotal = g ? d.iDeferLoading[1] : d.iDeferLoading));
					var t = q.oLanguage;
					...
					null === d.asStripeClasses &&
						(q.asStripeClasses = [i.sStripeOdd, i.sStripeEven]);
					var g = q.asStripeClasses,
						s = h('tbody tr', this).eq(0);
					-1 !==
						h.inArray(
							!0,
							h.map(g, function(a) {
					...
					d.bStateSave &&
						((v.bStateSave = !0),
						Kb(q, d),
						z(q, 'aoDrawCallback', ya, 'state_save'));
					if (d.aaSorting === k) {
						n = q.aaSorting;
						g = 0;
						for (j = n.length; g < j; g++)
					...
					0 === j.length || 0 === j.children().length
						? p.addClass(i.sNoFooter)
						: 0 < j.length && ((q.nTFoot = j[0]), da(q.aoFooter, q.nTFoot));
					if (d.aaData) for (g = 0; g < d.aaData.length; g++) J(q, d.aaData[g]);
					else
						(q.bDeferLoading || 'dom' == B(q)) &&
							ma(q, h(q.nTBody).children('tr'));
					...
					if ('table' === b) (f = c.call(q, l[g], g)), f !== k && d.push(f);
						...
						for (m = n.length; i < m; i++)
							(f = n[i]),
								(f =
									'cell' === b
										? c.call(q, l[g], f.row, f.column, g, i)
										: c.call(q, l[g], f, g, i, p)),
								f !== k && d.push(f);
					}
				}
				return d.length || e
		...
		var $a = function(a, b) {
				...
				for (g = a.length; f < g; f++) {
					...
					for (i = d.length; j < i; j++)
						(e = b('string' === typeof d[j] ? h.trim(d[j]) : d[j])) &&
							e.length &&
							c.push.apply(c, e);
				}
				return c;
		...
		r('cells()', function(a, b, c) {
			h.isPlainObject(a) &&
				(typeof a.row !== k ? ((c = b), (b = null)) : ((c = a), (a = null)));
		...
		o.isDataTable = o.fnIsDataTable = function(a) {
			...
			h.each(o.settings, function(a, d) {
				if (
					d.nTable === b ||
					h('table', d.nScrollHead)[0] === b ||
					h('table', d.nScrollFoot)[0] === b
				)
					c = !0;
			});
			return c;
		...
		h.extend(o.ext.type.detect, [
			...
			function(a) {
				return I(a) || ('string' === typeof a && -1 !== a.indexOf('<'))
					? 'html'
					: null;
			}
		]);
	...
	'function' === typeof define && define.amd
		? define('datatables', ['jquery'], O)
		: 'object' === typeof exports
		? (module.exports = O(require('jquery')))
		: jQuery && !jQuery.fn.dataTable && O(jQuery);
})(window, document);
